              ...
              <form autocomplete="off" action = "../Controller/Login_controller.php" class="login-form" method="POST">
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Email" aria-describedby="sizing-addon2" required="required" name="login-user">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <span class="input-group-addon" id="sizing-addon2"><i class="fa fa-lock"></i></span>
                    <input type="password" class="form-control" placeholder="Password" aria-describedby="sizing-addon2" required="required" name="login-password">
                  </div>
                </div>
