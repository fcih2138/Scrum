            ...
            <div class="new_comment">
                ...
                <ul class="user_comment">
                    ...
                    <div class="user_avatar">
                        ...
                        <div class="comment_header">Sent to ' . $result[$x]['username'] . ' <a href="http://localhost/SW2_Mohamed/Controller/Note_Message.php?note_id= ' . $result[$x]['note_id'] . '&user_id_send=' . $result[$x]['user_id_send'] . '&user_id_rec=' . $result[$x]['user_id_rec'] . '">' . $NoteTitle . '</a></div>
